...
class FriendshipController {
  ...
  static async showFriendsPage(req, res) {
    try {
      ...
      console.log("- Blocked friends count:", blockedFriends.length);
      ...
      console.log("=== showFriendsPage completed successfully ===");
    } catch (error) {
  ...
  static async sendFriendRequest(req, res) {
    try {
      ...
      console.log('حالة الصداقة الحالية:', currentStatus);
  ...
  static async getUnreadRequestsCount(req, res) {
    try {
      ...
      console.error("Error in getUnreadRequestsCount:", error);
